...
export async function extractHafsV13() {
  const content = readFileSync(resolve(dirname, '../raw-text/uthmanic-hafs-v13.docx'))
  ...
  writeFileSync(resolve(dirname, '../text/quran-text-hafs-v13.json'), JSON.stringify(ayat, null, 2))
}
